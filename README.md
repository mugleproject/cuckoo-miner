**This repository is now integrated directly into [mugle-miner](https://github.com/mugleproject/mugle-miner) and obsolete**

[![Build Status](https://travis-ci.org/mimblewimble/cuckoo-miner.svg?branch=master)](https://travis-ci.org/mimblewimble/cuckoo-miner) [![Gitter chat](https://badges.gitter.im/mugle_community/Lobby.png)](https://gitter.im/mugle_community/Lobby)
# cuckoo-miner
...
integration into the Mugle/Mimblewimble blockchain's proof-of-work system, however it aims to eventually be suitable for other 
...
A tag of cuckoo miner is intergrated into the master of Mugle, but for instructions on how to build cuckoo-miner and integrate it into 
Mugle locally, see the see the [build docs](doc/build.md).
...
to Mugle in a manner that changes them as little as possible. As written, they are optimised with a lot of static 
...
Cuckoo-miner is very much in experimental alpha phase, and will be developed more fully alongside Mugle. The many
variations on cuckoo size included are mostly for Mugle testing, and will likely be reduced once Mugle's POW parameters
...
A higher level overview of Cuckoo Cycle and how it relates to Mugle's Proof-of-work system can be found in 
[Mugle's POW Documentation](https://github.com/ignopeverell/mugle/blob/master/doc/pow/pow.md).
