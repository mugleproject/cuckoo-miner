...
//! let SAMPLE_MUGLE_PRE_HEADER_1:&str = "00000000000000118e0fe6bcfaa76c6795592339f27b6d330d8f9c4ac8e86171a66357d1\
...
//! 
//! let SAMPLE_MUGLE_POST_HEADER_1:&str = "010a020364";
//!
//! let mut d = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
//! d.push("target/debug/plugins/");
//!
...
//! 	let miner = cuckoo::CuckooMiner::new(config_vec.clone()).expect("");
//! 	let job_handle = miner.notify(1, SAMPLE_MUGLE_PRE_HEADER_1, SAMPLE_MUGLE_POST_HEADER_1, 0).unwrap();
//! 
//! 	loop {
