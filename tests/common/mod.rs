...
// Mugle Pre and Post headers, into which a nonce is to be insterted for mutation
pub const SAMPLE_MUGLE_PRE_HEADER_1:&str = "00000000000000118e0fe6bcfaa76c6795592339f27b6d330d8f9c4ac8e86171a66357d1\
...
pub const SAMPLE_MUGLE_POST_HEADER_1:&str = "010a020364";
...
pub fn mine_async_for_duration(full_paths: Vec<&str>, duration_in_seconds: i64, 
	...
	while time::get_time().sec < deadline {
		...
		let miner = CuckooMiner::new(config_vec.clone()).expect("");
		let job_handle = miner.notify(1, SAMPLE_MUGLE_PRE_HEADER_1, SAMPLE_MUGLE_POST_HEADER_1, 0, false).unwrap();
